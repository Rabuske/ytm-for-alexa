...
type searchReturnHelper<T extends {
    category: string;
}> = Omit<T, 'category'> & {
    category: T['category'] | 'Top result';
    thumbnails: thumbnails;
};
type searchAllUnion = searchReturnHelper<searchVideo> | searchReturnHelper<searchSong> | searchReturnHelper<searchAlbum> | searchReturnHelper<searchCommunityPlaylists> | searchReturnHelper<searchFeaturedPlaylists>;
export type searchMappedHelper = {
    ...
    playlists: (searchReturnHelper<searchCommunityPlaylists> | searchReturnHelper<searchFeaturedPlaylists>)[];
...
export type searchReturn<T extends keyof searchMappedHelper = 'null'> = searchMappedHelper[T];
export {};
