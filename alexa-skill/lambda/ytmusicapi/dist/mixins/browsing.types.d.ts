...
export type resultTypes = (Extract<resultType, 'artist' | 'playlist' | 'song' | 'video'> | parseSearchResultsAdditionalResultTypes)[];
...
export type getArtistResults = getArtistResponse['contents']['singleColumnBrowseResultsRenderer']['tabs'][number]['tabRenderer']['content']['sectionListRenderer']['contents'];
/**
 * getArtist
 */
